...
public class ArrayDemo {
	...
	public static void main(String[] args) {
		...
		int[] myIntArray1 = {100, 70, 90}; //shorter way to create an array, you give your values straight away. this way of doing this defines 
		//the size of the array straight away.
		
		/* --- another way to create an array - slightly longer as you have to first define the size of the array and then give a value for the array. this
		...
		System.out.println("0 index: " + myIntArray1[2]);
		//System.out.println("2nd index: " + myIntArray1[2]);
		
		String[] myStringArray1 = {"bmw", "audi", "honda", "mini"};
